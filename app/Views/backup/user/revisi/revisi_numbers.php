 ...
 <?php if ($user['status_verifikasi_revisi'] == null && $dokumen[0]['status'] == 'Not Verified') : ?>
 ...
 <?php elseif ($user['status_verifikasi_revisi'] == 'masspro' && $dokumen[0]['status'] == 'Verified') : ?>
     Terverifikasi
 <?php elseif ($user['status_revisi'] == 'masspro') : ?>
     Sedang direview
 <?php elseif ($user['status_revisi'] == 'masspro' && $dokumen[0]['status'] == 'masspro') : ?>
     Sedang direview
 <?php elseif ($user['status_revisi'] == null && $user['status_verifikasi_revisi'] == null) : ?>
     <button type="button" class="btn btn-info btn-update-pdf" data-bs-toggle="modal" data-bs-target="#modal-left" data-id-pdf="<?= $user['revisi_id'] ?>">
         Update PDF
     </button>

     <a href="#" class="btn btn-warning" data-revisi-id="<?= $user['revisi_id'] ?>" data-bs-toggle="modal" data-bs-target="#setmassproAgainModal">Set Masppro</a>
 <?php elseif ($user['status_revisi'] == '-' && $user['status_verifikasi_revisi'] == '-') : ?>
     <button type="button" class="btn btn-info btn-update-pdf" data-bs-toggle="modal" data-bs-target="#modal-left" data-id-pdf="<?= $user['revisi_id'] ?>">
         Update PDF
     </button>
 ...
 <?php elseif ($user['status_revisi'] == '-' && $dokumen[0]['status'] == 'masspro') : ?>
     <!-- Tampilkan tombol jika dokumen utama terkait belum diverifikasi -->
     <button type="button" class="btn btn-info btn-update-pdf" data-bs-toggle="modal" data-bs-target="#modal-left" data-id-pdf="<?= $user['revisi_id'] ?>">
         Update PDF
     </button>
