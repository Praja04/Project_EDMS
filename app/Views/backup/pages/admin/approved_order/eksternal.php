        ...
        <section class="content">
                        ...
                        <div class="box-body pe-0 ps-lg-50 ps-15 py-0">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-8">
                                    <h1 class="fs-40 text-white">Order Drawing Eksternal PCE</h1>
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3>List Order Drawing Need Approved</h3>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="example121" class="table text-center table-bordered table-separated">
                                        ...
                                        <tbody id="user">
                                            <?php $i = 1;
                                            foreach ($externalOrders as $user) : ?>
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3>History Order From External PCE</h3>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="example121" class="table text-center table-bordered table-separated">
                                        ...
                                        <tbody id="user">
                                            <?php $i = 1;
                                            foreach ($externalAllOrders as $user) : ?>
