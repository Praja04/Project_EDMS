        ...
        <section class="content">
                        ...
                        <div class="box-body pe-0 ps-lg-50 ps-15 py-0">
                            <div class="row align-items-center">
                                <div class="col-12 col-lg-8">
                                    <h1 class="fs-40 text-white">Update Jenis Project</h1>
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3>Daftar Semua Jenis Project</h3>
                </div>
                                        ...
                                        <tbody id="user2">
                                            ...
                                            foreach ($All as $user) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-danger btn-hapus" data-id="<?= $user['id'] ?>">Hapus</button>
                                                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal-left" data-no="<?= $user['id'] ?>" data-sub="<?= $user['nama_project'] ?>">Update</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
            ...
            <div class="row">
                <div class="col-lg-12 col-12" id="form1" style="width: 90%;padding-left: 7%;">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Form Buat Jenis Project Baru</h4><br>
                            <span>Silakan cek jenis project pada tabel!</span>
                        </div>
                        <!-- /.box-header -->
                        <form id="jenisproject" enctype="multipart/form-data">
                            <div class="box-body">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Update Jenis Project</h5>
                        </div>
            ...
            <div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Apakah Anda yakin ingin menghapus jenis project ini?
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#modal-left').on('show.bs.modal', function(event) {
            ...
            var modal = $(this);
            modal.find('#id').val(no);
            modal.find('#nama_project').attr('placeholder', sub);
        });
        ...
        $('#save-update-button').on('click', function() {
            ...
            $.ajax({
                url: baseUrl + 'update/jenis_project',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $('#confirmDeleteBtn').on('click', function() {
            if (deleteId) {
                deleteJenisProject(baseUrl, deleteId);
            }
    ...
    function submitData(baseUrl) {
        var formData = new FormData($('#jenisproject')[0]);

        $.ajax({
            url: baseUrl + 'create/jenisproject',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    function deleteJenisProject(baseUrl, id) {
        $.ajax({
            url: baseUrl + 'delete/jenisproject/' + id,
            type: 'POST',
            success: function(response) {
                showModal(response.message);
                setTimeout(function() {
