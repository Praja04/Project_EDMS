                         ...
                         <div class="box-body pe-0 ps-lg-50 ps-15 py-0">
                             <div class="row align-items-center">
                                 <div class="col-12 col-lg-8">
                                     <h1 class="fs-40 text-white">Halaman Revisi</h1>
                                             ...
                                             <?php $i = 1;
                                                foreach ($data as $user) : ?>
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td><a class="btn btn-primary" href="<?= base_url('uploader/revisi/detail/' . $user['dokumen_id']) ?>">Revisi</a></td>
                                                     <td>
                                                         <?php if ($user['keterangan_verifikasi'] != null) : ?>
                                                             <?= $user['keterangan_verifikasi'] ?>
                                                         <?php else : ?>
                                                             -
                                                         <?php endif; ?>
                                                     </td>
                                                     <td>
                                                         <?php
                                                            $valid_seen_values = [0, 1]; // Array nilai yang valid untuk is_seen
                                                            if (is_null($user['is_seen'])) : ?>
                                                             -
                                                         <?php elseif (in_array($user['is_seen'], $valid_seen_values)) : ?>
                                                     ...
                                                     <td>
                                                         <?php
                                                            if ($user['status_verifikasi'] == null) {
