  ...
  var testdata = {
    data: [
      ...
      },
      {
        ...
        contacts:
          "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/5.jpg' class='busy'></a> </div> ",
        status: "<span class='badge badge-success'>Active</span>",
        tracker:
          "<button type='button' class='btn btn-sm btn-toggle btn-info' data-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
        starts: "01-12-2017",
      ...
      },
      {
        ...
        est: "<td><div class='progress progress-sm'><div class='progress-bar progress-bar-primary progress-bar-striped' role='progressbar' aria-valuenow='55' aria-valuemin='0' aria-valuemax='100' style='width: 55%'></div></div></td>",
        contacts:
          "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/8.jpg' class='online'></a></div> ",
        status: "<span class='badge badge-success'>Active</span>",
        tracker:
          "<button type='button' class='btn btn-sm btn-toggle btn-info' data-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
        starts: "01-20-2017",
