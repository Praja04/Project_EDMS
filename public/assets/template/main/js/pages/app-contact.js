...
$(function () {
  ...
  $(".checkbox-toggle").click(function () {
    ...
    if (clicks) {
      ...
      $(".ion", this)
        .removeClass("ion-android-checkbox-outline")
        .addClass("ion-android-checkbox-outline-blank");
    } else {
      //Check all checkboxes
      $(".media-list input[type='checkbox']").iCheck("check");
      $(".ion", this)
        .removeClass("ion-android-checkbox-outline-blank")
        .addClass("ion-android-checkbox-outline");
    }
