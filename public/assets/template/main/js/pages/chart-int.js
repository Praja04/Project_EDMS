...
var Widgetschart = (function () {
  ...
  // Simple sparklines
  var _sparklinesWidget = function (
    element,
    chartType,
    qty,
    chartHeight,
  ...
  series: [
    {
      ...
      type: "bar",
      data: [
        7.2, 5.3, 6.1, 32.1, 23.1, 89.2, 158.4, 178.1, 36.4, 22.7, 7.1, 9.4,
      ],
      markPoint: {
        data: [
          { type: "max", name: "Max" },
    ...
    },
    {
      ...
      type: "bar",
      data: [
        19.4, 7.9, 8.9, 27.9, 24.8, 88.1, 167.8, 197.5, 47.1, 16.7, 7.1, 1.5,
      ],
      markPoint: {
        data: [
          {
