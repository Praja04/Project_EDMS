      ...
      this.dd
        .droppable(self.container, {
          accept: function (el) {
            ...
            return el.is(
              self.opts.acceptWidgets === true
                ? ".grid-stack-item"
                : self.opts.acceptWidgets,
            );
          },
        })
  ...
  GridStack.prototype._updateStyles = function (maxHeight) {
    ...
    if (
      ...
      getHeight = function (nbRows, nbMargins) {
        return (
          self.opts.cellHeight * nbRows +
          self.opts.verticalMargin * nbMargins +
