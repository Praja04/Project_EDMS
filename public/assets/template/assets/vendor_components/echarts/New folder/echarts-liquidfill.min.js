  ...
  return (function (t) {
          ...
          (d = f - m),
            ...
            d >= 0 && g < x
              ...
              : ((C[0] = a(t, r, i, s, p)),
                (C[1] = a(e, n, o, l, p)),
                (v = y(C, P)),
                p <= 1 && v < x ? ((f = p), (x = v)) : (m *= 0.5));
        return (
          c && ((c[0] = a(t, r, i, s, f)), (c[1] = a(e, n, o, l, f))), w(x)
        );
      }
      function c(t, e, r, n) {
        var i = 1 - n;
    ...
    function (t, e, r) {
      ...
      function f(t, e) {
        ...
        for (var s = 0; ; s++) {
          ...
          var l =
            0 === s
              ? d(t, a, e.ascCharWidth, e.cnCharWidth)
              : o > 0
      ...
      function v(t, e, r, n) {
        ...
        if ((r && (s += r[0] + r[2]), t && n)) {
          ...
          if (null != l && s > l) (t = ""), (a = []);
            ...
            for (
              var u = c(h - (r ? r[1] + r[3] : 0), e, n.ellipsis, {
                  minChar: n.minChar,
            ...
            if ("string" == typeof O && "%" === O.charAt(O.length - 1))
              ...
              if (D) {
                ...
                var L = S.textBackgroundColor,
                  B = L && L.image;
                B &&
                  ((B = b.findExistImage(B)),
                  b.isImageReady(B) &&
                    (O = Math.max(O, (B.width * k) / B.height)));
              }
              var F = T ? T[1] + T[3] : 0;
              O += F;
              ...
              null != R &&
                R < O &&
                (!D || R < F
                  ? ((w.text = ""), (w.textWidth = O = 0))
                  : ((w.text = u(w.text, R - F, M, f.ellipsis, {
                      minChar: f.minChar,
                    })),
                    (w.textWidth = A.getWidth(w.text, M)),
                    (O = w.textWidth + F)));
      ...
      (_.prototype = {
        ...
        _dashedBezierTo: function (t, e, r, i, a, o) {
          ...
          for (d < 0 && (d = f + d), d %= f, s = 0; s < 1; s += 0.1)
            (l = y(v, t, r, a, s + 0.1) - y(v, t, r, a, s)),
              (h = y(x, e, i, o, s + 0.1) - y(x, e, i, o, s)),
              (_ += m(l * l + h * h));
          for (; w < b && ((S += p[w]), !(S > d)); w++);
          for (s = (S - d) / _; s <= 1; )
            (u = y(v, t, r, a, s)),
        ...
        (o.createOrUpdateImage = function (t, e, r, i, o) {
          if (t) {
            if ("string" == typeof t) {
              ...
              return (
                l
                  ? ((e = l.image), !s(e) && l.pending.push(h))
                  : (!e && (e = new Image()),
                    (e.onload = n),
    ...
    function (t, e, r) {
      ...
      function i(t, e, r, n, i) {
        ...
        (l && !t.__dirty) ||
          (l = t.__textCotentBlock = v.parsePlainText(r, a, o, n.truncate));
        var c = l.outerHeight,
          p = l.lines,
          m = l.lineHeight,
          x = f(c, n, i),
        ...
        for (var F = 0; F < p.length; F++)
          L && e.strokeText(p[F], T, k), B && e.fillText(p[F], T, k), (k += m);
      }
      function a(t, e, r, n, i) {
        ...
        for (var M = 0; M < r.lines.length; M++) {
          for (
            var P,
              ...
              B = T,
              F = I - 1;
            D < I && ((P = C[D]), !P.textAlign || "left" === P.textAlign);

          )
            l(t, e, P, n, A, S, L, "left"), (O -= P.width), (L += P.width), D++;
          for (; F >= 0 && ((P = C[F]), "right" === P.textAlign); )
      ...
      function u(t, e, r, n, i, a, o) {
        var s = r.textBackgroundColor,
          ...
          u = m.isString(s);
        if (
          (d(e, "shadowBlur", r.textBoxShadowBlur || 0),
          ...
          f
            ? x.buildPath(e, { x: n, y: i, width: a, height: o, r: f })
            : e.rect(n, i, a, o),
            e.closePath();
        }
      ...
      function f(t, e, r) {
        ...
        if (r) {
          ...
          if (s instanceof Array)
            (n = r.x + p(s[0], r.width)), (i = r.y + p(s[1], r.height));
          else {
    ...
    function (t, e, r) {
      ...
      function o(t) {
        t.__isHover ||
          ...
          t.useHoverLayer
            ...
            : (t.style.extendFrom(t.__hoverStl), t.dirty(!1), (t.z2 += 1)),
          (t.__isHover = !0));
      }
      function s(t) {
        if (t.__isHover) {
      ...
      function x(t, e, r, n, i) {
        ...
        a ||
          ...
          null == o &&
            n.checkInside &&
            n.checkInside(e, t.textPosition) &&
            ((o = "#fff"),
            null == s && ((s = n.defaultTextColor), null == l && (l = 2))),
          ...
          (i && n.disableBox) ||
            ((t.textBackgroundColor = y(e.getShallow("backgroundColor"), n)),
      ...
      (L.Group = r(50)),
        ...
        (L.subPixelOptimizeLine = function (t) {
          var e = L.subPixelOptimize,
            ...
            n = t.style.lineWidth;
          return (
            I(2 * r.x1) === I(2 * r.x2) && (r.x1 = r.x2 = e(r.x1, n, !0)),
        ...
        (L.setText = function (t, e, r) {
          ...
          r === !1
            ? (n.forMerge = !0)
            : ((n.defaultTextColor = n.autoColor = r), (n.checkInside = g)),
            v(t, e, n),
            t.host && t.host.dirty && t.host.dirty(!1);
        }),
        ...
        (L.getTransform = function (t, e) {
          for (var r = M.identity([]); t && t !== e; )
            M.mul(r, t.getLocalTransform(), r), (t = t.parent);
          return r;
        }),
        (L.applyTransform = function (t, e, r) {
          return (
            e && !w.isArrayLike(e) && (e = k.getLocalTransform(e)),
            r && (e = M.invert([], e)),
        ...
        (L.groupTransition = function (t, e, r, n) {
          ...
          function a(t) {
            var e = { position: P.clone(t.position), rotation: t.rotation };
        ...
        (L.createIcon = function (t, e, r) {
          ...
          if (((r = r || { x: -1, y: -1, width: 2, height: 2 }), t))
            return 0 === t.indexOf("image://")
              ? ((n.image = t.slice(8)), w.defaults(n, r), new L.Image(e))
              : L.makePath(t.replace("path://", ""), e, r, "center");
        }),
        (t.exports = L);
    },
    function (t, e, r) {
      ...
      (o.linearMap = function (t, e, r, n) {
        ...
        (o.getPercentWithPrecision = function (t, e, r) {
          ...
          for (
            ...
            for (
              var c = Number.NEGATIVE_INFINITY, f = null, d = 0, p = u.length;
              d < p;
              ++d
            )
              u[d] > c && ((c = u[d]), (f = d));
        ...
        (h.updateTransform = function () {
          ...
          return r || e
            ? ((n = n || i.create()),
              ...
              void i.invert(this.invTransform, n))
            : void (n && o(n));
        }),
    ...
    function (t, e, r) {
      ...
      n.extendChartView({
        ...
        render: function (t, e, r) {
          ...
          S &&
            ((w = t.get("outline.borderDistance")),
          ...
          p
            ...
            .update(function (e, r) {
              ...
              (s.host = null),
                n.graphic.updateProps(i, { shape: o, style: s }, t),
    ...
    function (t, e, r) {
      function n(t, e, r) {
        function n(t, e, r) {
          c[e]
            ? (t.otherDims[e] = r)
            : ((t.coordDim = e), (t.coordDimIndex = r), v.set(e, !0));
        }
        function o(t, e, r) {
          if (r || null != e.get(t)) {
        ...
        for (var _ = 0; _ < x; _++) {
          ...
          null != b &&
            null == g.get(b) &&
            ((S.name = S.tooltipName = b), g.set(b, _)),
        ...
        for (var M = r.extraPrefix || "value", P = 0; P < x; P++) {
          var S = (m[P] = m[P] || {}),
            k = S.coordDim;
          null == k &&
            ((S.coordDim = o(M, v, r.extraFromZero)),
            (S.coordDimIndex = 0),
            (S.isExtraCoord = !0)),
    ...
    function (t, e, r) {
      ...
      function i(t, e, r) {
        for (
          ...
          n < e.length &&
          (!e[n] ||
            ((t = t && "object" == typeof t ? t[e[n]] : null), null != t));
          n++
        );
        ...
        (u.compressBatches = function (t, e) {
          function r(t, e, r) {
            for (var n = 0, i = t.length; n < i; n++)
              for (
                var a = t[n].seriesId,
                  o = u.normalizeToArray(t[n].dataIndex),
                  s = r && r[a],
                  l = 0,
                  h = o.length;
                l < h;
            ...
            l(e, function (n, i) {
              ...
              if (
                !(
                  ...
                  (r &&
                    r.includeMainTypes &&
                    s.indexOf(r.includeMainTypes, l) < 0)
                )
              ) {
                var u = { mainType: l };
                ("index" === h && "all" === n) || (u[h] = n);
            ...
            return (
              (h =
                0 === t.indexOf("image://")
                  ...
                  : 0 === t.indexOf("path://")
                    ? n.makePath(t.slice(7), {}, new i(e, r, a, o))
                    : new d({
                        shape: {
                          symbolType: t,
                          x: e,
                ...
                if (s) n.setItemVisual(e, "color", s);
                  ...
                  var l = n.getItemModel(e),
                    h =
                      ...
                      t.getColorFromPalette(n.getName(e), r);
        ...
        for (var u = 0, p = 0, g = 0, x = 0, y = 0, _ = 0; _ < t.length; ) {
          ...
          switch (
            ...
            case h.Q:
              if (r) {
                if (
                  f.containStroke(p, g, t[_++], t[_++], t[_], t[_ + 1], e, i, l)
                )
                  return !0;
    ...
    function (t, e, r) {
      ...
      (a.fromCubic = function (t, e, r, n, a, l, h, u, c, f) {
        var d,
          ...
          x = v(t, r, a, h, p);
        for (
          c[0] = 1 / 0, c[1] = 1 / 0, f[0] = -(1 / 0), f[1] = -(1 / 0), d = 0;
          d < x;
          d++
        ) {
          var y = m(t, r, a, h, p[d]);
    ...
    function (t, e, r) {
      ...
      s.prototype = {
        ...
        bind: function (t, e, r) {
          for (
            var n = this, i = r && r.style, a = !i, s = 0;
            s < o.length;
            s++
          ) {
            var l = o[s],
          ...
          if (
            ((a || n.fill !== i.fill) && (t.fillStyle = n.fill),
            (a || n.stroke !== i.stroke) && (t.strokeStyle = n.stroke),
            (a || n.opacity !== i.opacity) &&
        ...
        extendFrom: function (t, e) {
          if (t)
            for (var r in t)
              !t.hasOwnProperty(r) ||
                (e !== !0 &&
                  (e === !1 ? this.hasOwnProperty(r) : null == t[r])) ||
                (this[r] = t[r]);
        },
        set: function (t, e) {
      ...
      t.exports = function (t, e) {
        ...
        for (var s = 0; s < l; s++) {
          ...
          var v = p * p,
            m = p * v;
          a.push([
            n(h[0], g[0], u[0], c[0], p, v, m),
            n(h[1], g[1], u[1], c[1], p, v, m),
          ]);
        }
        return a;
      };
