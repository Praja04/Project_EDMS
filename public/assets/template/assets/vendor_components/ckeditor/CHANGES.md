...
- [#12157](https://dev.ckeditor.com/ticket/12157): Fixed: Lost text formatting on pressing _Tab_ when the [`config.tabSpaces`](https://docs.ckeditor.com/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-tabSpaces) configuration option value was greater than zero.
...
- [#10192](https://dev.ckeditor.com/ticket/10192): Closing lists with the _Enter_ key does not work with [Advanced Content Filter](https://docs.ckeditor.com/ckeditor4/docs/#!/guide/dev_advanced_content_filter) in several cases.
