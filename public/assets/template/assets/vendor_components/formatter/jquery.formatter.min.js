  ...
  var a = (function () {
      ...
      return (
        (a.parse = function (a) {
          ...
          for (i; f > i; i++)
            g < e.length && i === e[g].index
              ? j(e[g][1])
              : (c.chars[i - g * b] = a.charAt(i));
    ...
    b = (function () {
      ...
      return (
        ...
        (a.addListener = function (a, b, c) {
          return "undefined" != typeof a.addEventListener
    ...
    d = (function () {
      ...
      return (
        ...
        (a.set = function (a, b) {
          if (
            ("object" != typeof b && (b = { begin: b, end: b }),
            a.setSelectionRange)
          )
    ...
    e = (function (a, b, c) {
      function d(b, d) {
        ...
        if (
          ((f.opts = c.extend({}, e, d)),
          "undefined" != typeof f.opts.pattern &&
            ((f.opts.patterns = f._specFromSinglePattern(f.opts.pattern)),
      ...
      return (
        (d.addInptType = function (a, b) {
          f[a] = b;
        }),
        (d.prototype.resetPattern = function (c) {
          (this.opts.patterns = c
            ? this._specFromSinglePattern(c)
            : this.opts.patterns),
        ...
        (d.prototype._keyDown = function (a) {
          ...
          return b && c.isDelKeyDown(a.which, a.keyCode)
            ? (this._processKey(null, b), c.preventDefault(a))
            : void 0;
        }),
        (d.prototype._keyPress = function (a) {
          ...
          return (
            ...
            c.isDelKeyPress(a.which, a.keyCode) || d || c.isModifier(a)
              ? void 0
              : (this._processKey(String.fromCharCode(b), !1),
                c.preventDefault(a))
          );
        }),
        ...
        (d.prototype._processKey = function (a, d, e) {
          ...
          d ||
            ((this.val = c.addChars(this.val, a, this.sel.begin)),
            (this.delta += a.length)),
            this._formatValue(e);
        }),
        ...
        (d.prototype._removeChars = function () {
          ...
          for (var a = 0, b = 0; b <= this.mLength; b++) {
            ...
            (g = b >= this.sel.begin ? g + this.delta : g),
              (d = this.val.charAt(g)),
              ((e && e === d) || (f && f === d)) &&
                ((this.val = c.removeChars(this.val, g, g + 1)), a--);
          }
        ...
        (d.prototype._validateInpts = function () {
          for (var a = 0; a < this.val.length; a++) {
            ...
            (d || e) &&
              g &&
              ((this.val = c.removeChars(this.val, a, a + 1)),
              this.focusStart--,
              this.newPos--,
              this.delta--,
              a--);
        ...
        (d.prototype._addChars = function () {
          if (this.opts.persistent) {
            for (var a = 0; a <= this.mLength; a++)
              this.val.charAt(a) ||
                ((this.val = c.addChars(this.val, this.opts.placeholder, a)),
        ...
        (d.prototype._addChar = function (a) {
          var b = this.chars[a];
          return b
            ? (c.isBetween(a, [this.sel.begin - 1, this.newPos + 1]) &&
                (this.newPos++, this.delta++),
              a <= this.focus && this.focus++,
              this.hldrs[a] &&
                (delete this.hldrs[a],
                (this.hldrs[a + 1] = this.opts.placeholder)),
              void (this.val = c.addChars(this.val, b, a)))
            : !0;
        }),
  ...
  ($.fn[f] = function (a) {
    return (
      "object" == typeof a &&
        this.each(function () {
          $.data(this, "plugin_" + f) ||
            $.data(this, "plugin_" + f, new e(this, a));
        }),
