...
document
  .querySelector(".js-insert-at-index")
  .addEventListener("click", function () {
    mixer.insert(4, '<div class="mix cat-4" data-order="5">D 5</div>');
  });

document
  .querySelector(".js-remove-via-element")
  .addEventListener("click", function () {
...
document
  .querySelector(".js-remove-via-index")
  .addEventListener("click", function () {
    mixer.remove(3);
  });

document
  .querySelector(".js-insert-multiple-via-markup")
  .addEventListener("click", function () {
    mixer.prepend(
...
document
  .querySelector(".js-insert-multiple-via-elements")
  .addEventListener("click", function () {
    var h = mixitup.h,
      el1 = h.createElement('<div class="mix cat-4" data-order="1">D 1</div>')
        .children[0],
      el2 = h.createElement('<div class="mix cat-4" data-order="2">D 2</div>')
        .children[0],
      el3 = h.createElement('<div class="mix cat-4" data-order="3">D 3</div>')
        .children[0],
...
document
  .querySelector(".js-api-filter-compound")
  .addEventListener("click", function () {
...
document
  .querySelector(".js-api-limit-3")
  .addEventListener("click", function () {
    mixer.paginate({ limit: 3 });
  });

document
  .querySelector(".js-api-limit-inf")
  .addEventListener("click", function () {
    mixer.paginate({ limit: Infinity });
  });

document
  .querySelector(".js-api-limit-10")
  .addEventListener("click", function () {
