...
(window.Modernizr = (function (a, b, c) {
  ...
  for (var E in p)
    x(p, E) &&
      ((v = E.toLowerCase()), (e[v] = p[E]()), s.push((e[v] ? "" : "no-") + v));
  (e.addTest = function (a, b) {
    ...
    (e.testStyles = t),
    (g.className =
      g.className.replace(/\bno-js\b/, "") + (f ? " js " + s.join(" ") : ""));
  return e;
})(this, this.document)),
  (function (a, b) {
    function u() {
    ...
    if (!b) {
          ...
          for (; d < c; d++)
            (e = b[d]),
              ...
              !!f &&
                ...
                !h[f] &&
                (!/^([a-zA-Z]+?:(\/\/)?(www\.)?)/.test(f) ||
                f.replace(RegExp.$1, "").split("/")[0] === a.location.host
                  ? l.push({ href: f, media: g })
                  : (h[f] = !0));
          n();
        },
        n = function () {
            ...
            for (; k < o; k++)
              (m = n[k]),
                e.push({
                  ...
                  rules: f.length - 1,
                  minw:
                    m.match(/\(min\-width:[\s]*([\s]*[0-9]+)px[\s]*\)/) &&
                    parseFloat(RegExp.$1),
                  maxw:
                    m.match(/\(max\-width:[\s]*([\s]*[0-9]+)px[\s]*\)/) &&
                    parseFloat(RegExp.$1),
                });
          }
          r();
        ...
        r = function (a) {
          ...
          if (a && p && s - p < i) clearTimeout(q), (q = setTimeout(r, i));
            ...
            for (var t in e) {
              ...
              if (
                (!u.minw && !u.maxw) ||
                ((!u.minw || (u.minw && l >= u.minw)) &&
                  (!u.maxw || (u.maxw && l <= u.maxw)))
              )
            ...
            for (var t in m) {
              ...
              (v.type = "text/css"),
                ...
                v.styleSheet
                  ...
                  : v.appendChild(c.createTextNode(w)),
                n.appendChild(v),
                g.push(v);
            }
      ...
      m(),
        (respond.update = m),
        a.addEventListener
          ? a.addEventListener("resize", u, !1)
          : a.attachEvent && a.attachEvent("onresize", u);
    }
