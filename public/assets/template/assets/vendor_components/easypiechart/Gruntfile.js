module.exports = function (grunt) {
	grunt.initConfig({
		...
		uglify: {
			dist: {
				...
				files: {
					...
					"dist/jquery.<%= cfg.filename %>.min.js": [
						"dist/jquery.<%= cfg.filename %>.js",
					],
					"dist/angular.<%= cfg.filename %>.min.js": [
						"dist/angular.<%= cfg.filename %>.js",
					],
				},
			},
		},
		...
		jshint: {
			files: ["<%= dirs.src %>/**/*.js", "<%= dirs.test %>/**/*.js"],
			options: {},
		},
