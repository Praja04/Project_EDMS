...
!(function (a) {
    (FormValidation.Framework.Bootstrap = function (b, c, d) {
                ...
                _fixIcon: function (a, b) {
                    ...
                    if ("checkbox" === d || "radio" === d) {
                        ...
                        h.hasClass(d)
                            ? b.insertAfter(h)
                            : h.parent().hasClass(d) &&
                              b.insertAfter(h.parent());
                    }
                    0 === g.find("label").length &&
                        b.addClass("fv-icon-no-label"),
        ...
        (a.fn.bootstrapValidator.Constructor =
