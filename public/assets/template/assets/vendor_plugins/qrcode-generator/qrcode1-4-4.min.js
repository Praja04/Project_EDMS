var qrcode = (function () {
  function i(t, r) {
    ...
    var u = t,
      ...
      v = function (t, r) {
        for (
          var e = (f << 3) | r, n = B.getBCHTypeInfo(e), o = 0;
          o < 15;
          o += 1
        ) {
          var i = !t && 1 == ((n >> o) & 1);
      ...
      w = function (t, r, e) {
        for (
          var n = b.getRSBlocks(t, r), o = M(), i = 0;
          i < e.length;
          i += 1
        ) {
          var a = e[i];
        ...
        if (o.getLengthInBits() > 8 * u)
          throw (
            "code length overflow. (" + o.getLengthInBits() + ">" + 8 * u + ")"
          );
        for (
    ...
    (s.addData = function (t, r) {
      ...
      (s.make = function () {
        if (u < 1) {
          for (var t = 1; t < 40; t++) {
            for (
              var r = b.getRSBlocks(t, f), e = M(), n = 0;
              n < c.length;
              n++
            ) {
              var o = c[n];
      ...
      (s.createTableTag = function (t, r) {
        ...
        (e += '<table style="'),
          ...
          (e +=
            " padding: 0px; margin: " + (r = void 0 === r ? 4 * t : r) + "px;"),
          (e += '">'),
          (e += "<tbody>");
      ...
      (s.createSvgTag = function (t, r, e, n) {
        var o = {};
        "object" == typeof t &&
          ((t = (o = t).cellSize), (r = o.margin), (e = o.alt), (n = o.title)),
          (t = t || 2),
          (r = void 0 === r ? 4 * t : r),
            ...
            g +=
              n.text || e.text
                ? ' role="img" aria-labelledby="' +
                  p([n.id, e.id].join(" ").trim()) +
                  '"'
                : "",
            g += ">",
            g += n.text
              ? '<title id="' + p(n.id) + '">' + p(n.text) + "</title>"
              : "",
            g += e.text
              ? '<description id="' +
                p(e.id) +
    ...
    return (
              ...
              for (
                ...
                (i = "█"),
                  u <= e &&
                    ...
                    u <= r &&
                    r < f &&
                    s.isDark(n, Math.floor((e - u) / 1)) &&
                    (i = " "),
                  u <= e &&
                  e < f &&
                  u <= r + 1 &&
                  r + 1 < f &&
                  s.isDark(o, Math.floor((e - u) / 1))
                    ? (i += " ")
                    : (i += "█"),
                  (l += t < 1 && f <= r + 1 ? g[i] : c[i]);
              l += "\n";
      ...
      (s.renderTo2dContext = function (t, r) {
        ...
        for (var e = s.getModuleCount(), n = 0; n < e; n++)
          for (var o = 0; o < e; o++)
            (t.fillStyle = s.isDark(n, o) ? "black" : "white"),
  ...
  var r,
    ...
    B =
      ...
      ((t = {}).getBCHTypeInfo = function (t) {
        for (var r = t << 10; 0 <= d(r) - d(1335); )
          r ^= 1335 << (d(r) - d(1335));
        return 21522 ^ ((t << 10) | r);
      }),
      (t.getBCHTypeNumber = function (t) {
        for (var r = t << 12; 0 <= d(r) - d(7973); )
          r ^= 7973 << (d(r) - d(7973));
        return (t << 12) | r;
      }),
        ...
        multiply: function (t) {
          for (
            ...
            for (var n = 0; n < t.getLength(); n += 1)
              r[e + n] ^= w.gexp(w.glog(i.getAt(e)) + w.glog(t.getAt(n)));
          return C(r, 0);
        },
        mod: function (t) {
          if (i.getLength() - t.getLength() < 0) return i;
          for (
            var r = w.glog(i.getAt(0)) - w.glog(t.getAt(0)),
    ...
    b =
      ...
      ((A = {}).getRSBlocks = function (t, r) {
        ...
        for (var n, o, i = e.length / 3, a = [], u = 0; u < i; u += 1)
          for (
            var f = e[3 * u + 0], c = e[3 * u + 1], g = e[3 * u + 2], l = 0;
            l < f;
            l += 1
          )
            a.push(
      ...
      for (
        var n = (function (t, r) {
            var n = t,
              ...
              i = function (t) {
                for (
                  var r = 1 << t, e = 1 + (1 << t), n = t + 1, o = h(), i = 0;
                  i < r;
                  i += 1
                )
