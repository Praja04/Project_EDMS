...
FullCalendar.List = (function (exports, core, internal$1, preact) {
      ...
      let renderProps = Object.assign(
        {
          ...
          sideNavLinkAttrs: internal$1.buildNavLinkAttrs(
            this.context,
            dayDate,
            "day",
            false,
  ...
  function renderInnerContent(props) {
    return preact.createElement(
      ...
      props.sideText &&
        /* not keyboard tabbable */ preact.createElement(
          "a",
          Object.assign(
  ...
  function buildTimeContent(
    ...
    if (options.displayEventTime !== false) {
      ...
      if (eventDef.allDay) {
        doAllDay = true;
      } else if (internal$1.isMultiDayRange(seg.eventRange.range)) {
        // TODO: use (!isStart || !isEnd) instead?
        if (seg.isStart) {
          timeText = internal$1.buildSegTimeText(
            seg,
            timeFormat,
            context,
            null,
        ...
        (nowDate, todayRange) => {
          ...
          for (let dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
            ...
            if (daySegs) {
              ...
              // append a day header
              innerNodes.push(
                preact.createElement(ListViewHeaderRow, {
                  key: dayStr,
                  cellId: dateHeaderId,
