...
FullCalendar.DayGrid = (function (exports, core, internal$1, preact) {
  ...
  class TableView extends internal$1.DateComponent {
    ...
    renderHScrollLayout(headerRowContent, bodyContent, colCnt, dayMinWidth) {
      ...
      let stickyHeaderDates =
        !props.forPrint && internal$1.getStickyHeaderDates(context.options);
      let stickyFooterScrollbar =
        !props.forPrint && internal$1.getStickyFooterScrollbar(context.options);
      let sections = [];
      if (headerRowContent) {
        sections.push({
          type: "header",
  ...
  class TableListItemEvent extends internal$1.BaseComponent {
    render() {
      ...
      let timeText = internal$1.buildSegTimeText(
        seg,
        timeFormat,
        context,
        true,
  ...
  const DEFAULT_WEEK_NUM_FORMAT = internal$1.createFormatter({
    week: "narrow",
  });
        ...
        (InnerContent, renderProps) =>
          preact.createElement(
            ...
            props.showWeekNumber &&
              preact.createElement(internal$1.WeekNumberContainer, {
                elTag: "a",
            ...
            !renderProps.isDisabled &&
              (props.showDayNumber ||
                internal$1.hasCustomDayCellContent(options) ||
                props.forceDayTop)
              ? preact.createElement(
                  "div",
  ...
  class DayGridSegHierarchy extends internal$1.SegHierarchy {
    ...
    addSegs(segInputs) {
      ...
      const excludeHidden = (entry) =>
        !this.forceHidden[internal$1.buildEntryKey(entry)];
        ...
        if (!forceHidden[touchingEntryId]) {
          if (this.allowReslicing) {
            const placeholderEntry = Object.assign(
              ...
              {
                span: internal$1.intersectSpans(touchingEntry.span, entry.span),
              },
            );
            const placeholderEntryId =
              internal$1.buildEntryKey(placeholderEntry);
      ...
      return preact.createElement(
        ...
        props.cells.map((cell, col) => {
          ...
          return preact.createElement(TableCell, {
            ...
            fgContent: preact.createElement(
              preact.Fragment,
              null,
            ...
            // Fragment scopes the keys
            bgContent: preact.createElement(
              preact.Fragment,
              null,
      ...
      if (
        ...
        if (isExternalSizingChange) {
          ...
          if (frameEls.length) {
            ...
            let newPositionCache = new internal$1.PositionCache(
              originEl,
              frameEls,
              true, // isHorizontal
              false,
            ...
            if (
              ...
              this.setState({
                framePositions: new internal$1.PositionCache(
                  originEl,
                  frameEls,
                  true, // isHorizontal
                  false,
  ...
  function getScrollSubjectEl(containerEl, dateProfile) {
    ...
    if (dateProfile.currentRangeUnit.match(/year|month/)) {
      el = containerEl.querySelector(
        `[data-date="${internal$1.formatIsoMonthStr(dateProfile.currentDate)}-01"]`,
      );
      // even if view is month-based, first-of-month might be hidden...
    }
    if (!el) {
      el = containerEl.querySelector(
        `[data-date="${internal$1.formatDayString(dateProfile.currentDate)}"]`,
      );
  ...
  class DayTableView extends TableView {
    ...
    render() {
      ...
      let headerContent =
        options.dayHeaders &&
        preact.createElement(internal$1.DayHeader, {
          ref: this.headerRef,
          dateProfile: props.dateProfile,
  ...
  function buildDayTableModel(dateProfile, dateProfileGenerator) {
    let daySeries = new internal$1.DaySeriesModel(
      dateProfile.renderRange,
      dateProfileGenerator,
    );
    return new internal$1.DayTableModel(
      daySeries,
