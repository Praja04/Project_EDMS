...
FullCalendar.Interaction = (function (exports, core, internal) {
  ...
  class OffsetTracker {
    constructor(el) {
      ...
      this.scrollCaches = internal
        .getClippingParents(el)
        .map((scrollEl) => new ElementScrollGeomCache(scrollEl, true));
    }
    destroy() {
      for (let scrollCache of this.scrollCaches) {
        scrollCache.destroy();
  ...
  class HitDragging {
    ...
    processFirstCoord(ev) {
      ...
      if (initialHit) {
        if (this.useSubjectCenter && subjectRect) {
          let slicedSubjectRect = internal.intersectRects(
            subjectRect,
            initialHit.rect,
          );
    ...
    prepareHits() {
      this.offsetTrackers = internal.mapHash(
        this.droppableStore,
        (interactionSettings) => {
    ...
    constructor(settings) {
      ...
      this.handleDragEnd = (ev) => {
        if (this.isDragging) {
          ...
          let eventApi = new internal.EventImpl(
            initialContext,
            eventDef,
            eventInstance,
          );
          ...
          if (validMutation) {
            ...
            if (receivingContext === initialContext) {
              let updatedEventApi = new internal.EventImpl(
                initialContext,
              ...
              let eventChangeArg = {
                ...
                relatedEvents: internal.buildEventApis(
              ...
              let addedEventInstance =
                mutatedRelevantEvents.instances[eventInstance.instanceId];
              let addedEventApi = new internal.EventImpl(
                receivingContext,
                addedEventDef,
                addedEventInstance,
              );
    ...
    constructor(settings) {
      ...
      this.handleHitUpdate = (hit, isFinal, ev) => {
        ...
        if (mutation) {
          ...
          interaction.mutatedEvents = mutatedRelevantEvents;
          if (
            !internal.isInteractionValid(interaction, hit.dateProfile, context)
          ) {
            isInvalid = true;
            mutation = null;
            mutatedRelevantEvents = null;
        ...
        if (this.validMutation) {
          ...
          context.emitter.trigger(
            ...
            Object.assign(Object.assign({}, eventChangeArg), {
              el: this.draggingSegEl,
              startDelta:
                this.validMutation.startDelta || internal.createDuration(0),
              endDelta:
                this.validMutation.endDelta || internal.createDuration(0),
              jsEvent: ev.origEvent,
              view: context.viewApi,
            }),
          );
  ...
  class UnselectAuto {
    constructor(context) {
      ...
      this.onDocumentPointerDown = (pev) => {
        ...
        this.matchesEvent = !!internal.elementClosest(
          downEl,
        ...
        if (hit) {
          ...
          if (this.canDropElOnCalendar(ev.subjectEl, receivingContext)) {
            ...
            interaction.mutatedEvents =
              internal.eventTupleToStore(droppableEvent);
            isInvalid = !internal.isInteractionValid(
              interaction,
              hit.dateProfile,
              receivingContext,
            );
  ...
  function computeEventForDateSpan(dateSpan, dragMeta, context) {
    ...
    let def = internal.parseEventDef(
      refined,
      extra,
      dragMeta.sourceId,
      dateSpan.allDay,
