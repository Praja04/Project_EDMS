...
(c) 2023 Adam Shaw
*/
FullCalendar.TimeGrid = (function (
  exports,
  core,
  internal$1,
  preact,
  ...
  function TimeColsAxisCell(props) {
    ...
    return preact.createElement(
      internal$1.ViewContextType.Consumer,
      null,
      (context) => {
        if (!props.isLabeled) {
    ...
    renderSimpleLayout(headerRowContent, allDayContent, timeContent) {
      ...
      if (allDayContent) {
        ...
        sections.push({
          ...
          outerContent: preact.createElement(
            "tr",
  ...
  class TimeColsSlatsCoords {
    ...
    safeComputeTop(date) {
      ...
      if (internal$1.rangeContainsMarker(dateProfile.currentRange, date)) {
        ...
        if (
          timeMs >= internal$1.asRoughMs(dateProfile.slotMinTime) &&
    ...
    computeTimeTop(duration) {
      ...
      let slatCoverage =
        (duration.milliseconds -
          internal$1.asRoughMs(dateProfile.slotMinTime)) /
        internal$1.asRoughMs(this.slotDuration);
      let slatIndex;
      let slatRemainder;
  ...
  function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
    ...
    for (; level < levelCnt; level += 1) {
      ...
      let entry;
      let searchIndex = internal$1.binarySearch(
        entries,
        subjectEntry.span.start,
        internal$1.getEntrySpanEnd,
      );
  ...
  class TimeCols extends internal$1.DateComponent {
    ...
    queryHit(positionLeft, positionTop) {
      ...
      if (colIndex != null && slatIndex != null) {
        ...
        let time = internal$1.addDurations(
  ...
  function processSlotOptions(slotDuration, snapDurationOverride) {
    ...
    let snapsPerSlot = internal$1.wholeDivideDurations(
      slotDuration,
      snapDuration,
    );
  ...
  function buildSlatMetas(
    ...
    while (internal$1.asRoughMs(slatTime) < internal$1.asRoughMs(slotMaxTime)) {
      ...
      let isLabeled =
        internal$1.wholeDivideDurations(slatIterator, labelInterval) !== null;
      metas.push({
        date,
        time: slatTime,
  ...
  function computeLabelInterval(slotDuration) {
    ...
    for (i = STOCK_SUB_DURATIONS.length - 1; i >= 0; i -= 1) {
      ...
      slotsPerLabel = internal$1.wholeDivideDurations(
        labelInterval,
        slotDuration,
      );
