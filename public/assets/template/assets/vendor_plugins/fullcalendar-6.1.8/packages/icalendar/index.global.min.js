...
FullCalendar.ICalendar = (function (e, t, n, r) {
  ...
  class i {
    constructor(e) {
      (this.maxIterations = null != e.maxIterations ? e.maxIterations : 1e3),
        (this.skipInvalidDates =
          null != e.skipInvalidDates && e.skipInvalidDates),
        (this.jCalData = s.parse(e.ics)),
        (this.component = new s.Component(this.jCalData)),
    ...
    between(e, t) {
      ...
      function r(e) {
        ...
        return (
          e.endDate.isDate && n > t && (n -= 1), { startTime: t, endTime: n }
        );
      }
      const a = [];
      ...
      return (
        this.events
          ...
          .forEach((e) => {
            const i = [];
            if (
              (e.component.getAllProperties("exdate").forEach((e) => {
              ...
              do {
                if (((l += 1), (c = o.next()), c)) {
                  ...
                  n(l, u) &&
                    (p ? s.events.push(p) : d || s.occurrences.push(o));
                }
              } while (c && (!this.maxIterations || l < this.maxIterations));
              return;
            }
            const { startTime: o, endTime: c } = r(e);
  ...
  const o = {
    parseMeta: (e) =>
      e.url && "ics" === e.format ? { url: e.url, format: "ics" } : null,
    fetch(e, t, n) {
      ...
      (a && !e.isRefetch) ||
        (a = r.internalState =
          {
            response: null,
            iCalExpanderPromise: fetch(r.url, { method: "GET" }).then((e) =>
              e
                .text()
                .then(
                  (t) => (
                    (a.response = e), new i({ ics: t, skipInvalidDates: !0 })
                  ),
                ),
            ),
          }),
        a.iCalExpanderPromise.then((n) => {
          t({ rawEvents: c(n, e.range), response: a.response });
        }, n);
    },
  };
  function c(e, t) {
  ...
  function d(e) {
    return (
      Boolean(e.component.getFirstProperty("dtend")) ||
      Boolean(e.component.getFirstProperty("duration"))
    );
  }
